...
import mariana.thePotteryPlace.security.dto.AuthenticationResponse;
import mariana.thePotteryPlace.security.dto.UserResponseDTO;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            ...
            //Caso ocorra sucesso será chamado o metodo: successfulAuthentication dessa classe
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        String token = JWT.create()
                // o objeto authResult possui os dados do usuário autenticado, nesse caso o metodo getName() retorna o username do usuário foi autenticado no metodo attemptAuthentication.
